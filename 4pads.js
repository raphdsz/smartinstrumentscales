...
majScale.addEventListener("touchend",function(e){
    e.preventDefault();
...
majPenScale.addEventListener("touchend",function(e){
    e.preventDefault();
...
minScale.addEventListener("touchend",function(e){
    e.preventDefault();
    majScale.classList.remove("active");
    majPenScale.classList.remove("active");
...
minPenScale.addEventListener("touchend",function(e){
    e.preventDefault();
    majScale.classList.remove("active");
    majPenScale.classList.remove("active");
    minScale.classList.remove("active");
...
chrScale.addEventListener("touchend",function(e){
    e.preventDefault();
    majScale.classList.remove("active");
    majPenScale.classList.remove("active");
    minScale.classList.remove("active");
...
function createPads(startingPads){
    let html = "";
    ...
    const numOfMaxPads =  numOfPadsInRow*4;
    ...
    for (let padsIndex = 1; padsIndex <=numOfMaxPads; padsIndex++){
        ...
        if (startingPads==="startingPads"){
            ...
            html += `<div class="pad active ${notesClass[notesIndex]} padcolor${notesIndex} ${chr}" data-sound="${currentNote}${octIndex}" ><p>${currentNote}<sub>${octIndex}</sub></p></div>`;
        }
